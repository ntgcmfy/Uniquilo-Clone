...
const ProductList: React.FC = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (mounted && db && db.length > 0) {
          setRemoteProducts(db);
        }
      } catch (e) {
  ...
  const filteredProducts = useMemo(() => {
    let result = sourceProducts.filter(product => product.category === category);
    ...
    return result;
  }, [category, selectedSubcategory, sortBy, priceRange, sourceProducts]);
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 sticky top-24">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  ...
                  <button 
                    onClick={() => {
                                      const saleProducts = sourceProducts.filter(p => p.isSale && p.category === category);
